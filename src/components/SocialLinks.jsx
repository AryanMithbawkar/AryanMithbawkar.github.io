...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/aryanmithbawkar/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@aron_wolverine",
    icon: Instagram,
    url: "https://www.instagram.com/aron_wolverine/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@playingwithwolverine4433",
    icon: Youtube,
    url: "https://www.youtube.com/@playingwithwolverine4433",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@AryanMithbawkar",
    icon: Github,
    url: "https://github.com/AryanMithbawkar",
    color: "#ffffff",
  ...
  },
  {
    name: "Twitter",
    displayName: "Twitter",
    subText: "@a_mithbawkar",
    icon: Twitter,
    url: "https://x.com/a_mithbawkar",
    color: "#ffffff",
    gradient: "from-[#333] to-[#24292e]"
  }
];
